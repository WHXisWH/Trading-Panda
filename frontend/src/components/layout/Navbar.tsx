...
export function Navbar() {
  ...
  return (
    <header className="sticky top-4 z-[var(--z-navbar)] overflow-visible px-4 md:px-5">
      <div className="product-topbar mx-auto flex max-w-page flex-wrap items-center justify-between gap-3 px-3 py-3">
        <Link href="/" className="flex min-w-[200px] items-center gap-3" aria-label="TradingPanda Home">
          <span className="product-brand-logo" aria-hidden />
          <span>
